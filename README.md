...
- The ARC path enables classification loss and ARC-specific candidate generation, including a support-only symbolic color-mapping primitive and clipped long-horizon support adaptation. These are executable DSL programs, not post-hoc result wrappers.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| smoke | `154` | `4` | `3` | `0.5911805556` | `0.6203472222` | `+0.0291666667` | `0.0 -> 0.0` |
| quick | `169` | `5` | `3` | `0.6445714286` | `0.7255510204` | `+0.0809795918` | `0.0 -> 0.0` |
| full | `185` | `8` | `5` | `0.6680555556` | `0.6794444444` | `+0.0113888889` | `0.0 -> 0.0` |

Interpretation: the operator/program RSI loop now shows a real held-out cell-accuracy improvement on the public ARC-AGI-1 same-shape subset, including full mode. It still does not solve exact ARC grids, and it is not an official ARC leaderboard result. In quick/full mode the evolved symbolic rule can increase classification loss while improving discrete cell accuracy, so cell accuracy is the primary proof metric for this adapter.
